#!/bin/bash
# This script runs infSCITE for the EEC128 dataset with specified parameters.

input="EEC128.genotypes.csv"
basename="EEC128"
rep=10              # the desired number of repetitions of the MCMC.
chainLength=10000   # the desired chain length of each MCMC repetition
ad1=0.171           # the estimated rate of missed heterozygous mutations in the sequencing experiment, or allele dropout rate
