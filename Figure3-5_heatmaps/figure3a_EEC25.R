...
main <- function(){
	...
	genotypes <- readRDS("../output_final/mutation_data/EEC25.filtered_small_clusters.rds")$genotypes_tumor
	...
	# Save heatmaps
	pdf(file.path(outdir,"/figure3a_EEC25.pdf"), width=8, height=6)
	draw(ht)
	dev.off()
