...
main <- function(){
	...
	genotypes <- readRDS("../output_final/mutation_data/EEC91.filtered_small_clusters.rds")$genotypes_tumor
	...
	# Save heatmaps
	pdf(file.path(outdir,"/figure3d_EEC91.pdf"), width=8, height=6)
	draw(ht)
	dev.off()
