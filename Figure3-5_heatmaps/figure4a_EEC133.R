...
main <- function(){
	...
	genotypes <- readRDS("../output_final/mutation_data/EEC133.filtered_small_clusters.rds")$genotypes_tumor
	...
	# Save heatmaps
	pdf(file.path(outdir,"/figure4a_EEC133.pdf"), width=8, height=6)
	draw(ht)
	dev.off()
